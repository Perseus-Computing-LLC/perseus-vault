...
- You want **89 canonical MCP tools** for the full memory lifecycle
...
## MCP Tools: 89 canonical vs 8

Perseus Vault's 89 canonical MCP tools cover the entire memory surface. Letta exposes ~8 tools
