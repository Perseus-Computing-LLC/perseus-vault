...
| **MCP Tools** | 89 canonical | 0 (not MCP-native) |
...
## MCP Tools: 89 canonical vs 0

This is the biggest gap. Perseus Vault has 89 canonical MCP tools. Zep has zero — it's not
...
- 89 canonical tools vs 0 MCP tools
- Encryption at rest
