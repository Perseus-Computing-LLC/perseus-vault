...
| AI RMF Subcategory | How We Address It |
|---|---|
| **MANAGE 1.1** — AI risks prioritized and responded to | Public issue trackers for both repos. Security vulnerability reporting process (perseus@perseus.observer, 48-hour response). Correction capture (Perseus Vault: perseus_vault_correct tool). |
