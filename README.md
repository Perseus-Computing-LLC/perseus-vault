...
bi-temporal history, and **AES-256-GCM** at rest, exposed as **161 canonical MCP tools**that work with any host. Legacy `mimir_*`/`mneme_*` aliases were removed in the 2026-27
