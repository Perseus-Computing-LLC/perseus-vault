...
case. Its exact fixture bytes are pinned by SHA-256:
`769fc34e8e2305672aed2defecc92ef29d97805f855606aa05b5293890a9fc0c`. It stores case IDs and expected behavior, not raw model prompts, provider
