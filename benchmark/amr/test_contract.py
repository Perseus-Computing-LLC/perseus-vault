...
class ExportTests(unittest.TestCase):
    ...
    def test_export_rejects_benchmark_fields_at_any_depth(self):
        for field in ("raw_prompt", "question", "question_id", "question_type", "answer_session_ids", "evaluator_metadata", "hidden_label", "api_key", "api-key", "authorization", "password", "password_hash", "private_key", "private-key", "private_key_path", "private_key_material", "secret_key", "secret-key", "access-token", "benchmark_id", "model_name", "provider_name", "model", "provider", "judge", "dataset", "split"):
            card = card_fixture()
...
class ContractTests(unittest.TestCase):
    ...
    def test_extensions_reject_benchmark_and_provider_payloads(self):
        for field in ("raw_prompt", "model", "provider", "judge", "dataset", "split", "access-token", "private-key", "password_hash", "benchmark_id", "provider_name", "model_name"):
