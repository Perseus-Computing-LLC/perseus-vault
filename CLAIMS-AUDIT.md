...
- Clarified that `federate` is a local export / workspace-rename / re-import
  ...
  in #704.
- Tool-count note refreshed: the current registry contains 91 unique canonical
...
- **91 canonical MCP tools**: ✓ The current registry contains 91 distinct base
...
- 2026-06-12 (v0.5.0): 23 tools. 2026-06 interim: 30 tools (#130). 2026-06-28
  ...
  mimir_check_failure_pattern). Now **91** (registry-derived; #520 mimir_capture and subsequent tools).
